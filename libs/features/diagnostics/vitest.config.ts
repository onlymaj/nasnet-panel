...
/**
 * Vitest Configuration for Diagnostics Feature
 *
 * Configured for:
 * - JSDOM environment for React component testing
 * - Proper alias resolution for monorepo imports
 * - 90% coverage target for utilities and hooks
 */
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@nasnet/features/dashboard': path.resolve(__dirname, '../dashboard/src'),
      '@nasnet/features/diagnostics': path.resolve(__dirname, './src'),
    },
  },
});
